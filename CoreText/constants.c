...
const CFStringRef kCTStrokeColorAttributeName = CFSTR("NSStrokeColor");
...
const CFStringRef kCTFontCollectionRemoveDuplicatesOption = CFSTR("CTFontCollectionRemoveDuplicates");
